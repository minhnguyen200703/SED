...
public:
    // Constructors
    Member(std::string username, std::string password, std::string fullName, std::string phoneNumber, std::string idType,
        std::string idNumber, std::string driverLicenseNumber, std::string expiryDate, std::string city);
...
void changeRequestStatusById(std::string requestId, const std::string& newStatus);
    // Getter functions
    ...
    void setMotorbike(Motorbike& newMotorbike);
    ...
    std::vector<RentalRequest> acceptRequest(RentalRequest* request);
